...
contract AdministrationMaster {
    ...
    /**
     * @dev The Administration Logic Contract address
     */
    ...
    /**
     * @param impl the address of the admin logic contract
     * @param admin the address of the first ADMIN
     * @dev Sets the address for the _administrationLogic contract as well as the first ADMIN
     * The _administrationLogic address can be updated later on.
     * The ADMIN can only be deleted by another ADMIN.
     */
    constructor (address impl, address admin) public {
        _administrationLogic = impl;
    ...
    /**
     * @dev Returns the address of the contract currently set as the _administrationLogic contract
     * @return the address of the contract currently set as the _administrationLogic contract
     */
    function administrationLogicAddress() public view returns (address) {
        return _administrationLogic;
    }
    ...
    */
    function() external {
        ...
        address _impl = _administrationLogic;
